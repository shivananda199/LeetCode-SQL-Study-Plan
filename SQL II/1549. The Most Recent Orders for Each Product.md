...
o.order_date
FROM Products p
LEFT JOIN max_order_dates m ON p.product_id = m.product_id
JOIN Orders o ON p.product_id = o.product_id AND m.max_order_date = o.order_date
...
WHERE o.order_date = (SELECT MAX(order_date) FROM Orders o1 WHERE o1.product_id = p.product_id)
ORDER BY p.product_name, p.product_id, o.order_id;
```